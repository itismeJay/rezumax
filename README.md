...
Testing the CI pipeline and commit and push
...
🔗 Live Demo: renhance.vercel.app

📸 Preview

Renhance features a real-time preview that mirrors the exported PDF exactly — what you see is what you get.
...
git clone https://github.com/itsnotjay/renhance.git
cd renhance
...
# Database
DATABASE_URL=postgresql://user:password@host:5432/renhance
...
GitHub: @itsmeJay
LinkedIn: linkedin.com/in/rbjay-salamanes
...
Jake Ryan Resume Template
 — Original LaTeX resume design
React-PDF
 — PDF generation library
Drizzle ORM
 — TypeScript ORM
NeetCode
 — For keeping me sharp while building this 😄
